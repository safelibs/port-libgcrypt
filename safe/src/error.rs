...
pub(crate) const GPG_ERR_BUG: u32 = 59;
pub(crate) const GPG_ERR_INV_OP: u32 = 61;
pub(crate) const GPG_ERR_INTERNAL: u32 = 63;
...
pub(crate) const GPG_ERR_MISSING_KEY: u32 = 181;
pub(crate) const GPG_ERR_BUFFER_TOO_SHORT: u32 = 200;
pub(crate) const GPG_ERR_UNFINISHED: u32 = 199;
