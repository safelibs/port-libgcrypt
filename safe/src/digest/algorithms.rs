...
pub(crate) fn asnoid(algo: c_int) -> Option<&'static [u8]> {
    match algo {
        GCRY_MD_MD5 => Some(MD5_ASNOID),
        GCRY_MD_SHA1 => Some(SHA1_ASNOID),
        GCRY_MD_RMD160 => Some(RMD160_ASNOID),
        GCRY_MD_SHA224 => Some(SHA224_ASNOID),
        GCRY_MD_SHA256 => Some(SHA256_ASNOID),
        GCRY_MD_SHA384 => Some(SHA384_ASNOID),
        GCRY_MD_SHA512 => Some(SHA512_ASNOID),
        GCRY_MD_MD4 => Some(MD4_ASNOID),
        GCRY_MD_TIGER1 => Some(TIGER1_ASNOID),
        GCRY_MD_SHA512_256 => Some(SHA512_256_ASNOID),
        GCRY_MD_SHA512_224 => Some(SHA512_224_ASNOID),
        _ => None,
    }
}
